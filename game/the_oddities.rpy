label menu_dahr_book:
    ...
    python:
        ...
        choose.AddItem("- Never mind -", "the_oddities", True, "")
...
#            elif _block=="gears" and o._block=="gears": 
                if o._block==_block:
                    choose.AddItem("- "+o._caption+" - ("+str(o._price)+" гал.) -" if _temp and itsDAHR.Count(o.Name)>0 else "{color=#858585}- The item is out of stock -{/color}", 
