...
init -1 python hide:
    ...
    config.window_title = u"Witch Trainer v.1.2.2c (Russian edition)"
...
python early:
    config.save_directory = "Hermione Trainer-1399954896"
...
init python:
    ...
    build.directory_name = "Witch_Trainer_1.2.2c_rus"
