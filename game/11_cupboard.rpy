label cupboard:
    menu:
        ...
        "- Sacred scrolls volume III -" if not day == 1 and cataloug_found:
            label sc_col_men_2:
            menu:
                "-S.31: [scroll_31_name] -" if sscroll_31 or persistent.ss_31:
                ...
                "-S.32: [scroll_32_name] -" if sscroll_32 or persistent.ss_32:
                ...
                "-S.33: [scroll_33_name] -" if sscroll_33 or persistent.ss_33:
                ...
                "-S.34: [scroll_34_name] -" if sscroll_34 or persistent.ss_34:
                ...
                "-S.35: [scroll_35_name] -" if sscroll_35 or persistent.ss_35:
                ...
                "-S.36: [scroll_36_name] -" if sscroll_36 or persistent.ss_36:
                ...
                "-S.37: [scroll_37_name] -" if sscroll_37 or persistent.ss_37:
                ...
                "-S.38: [scroll_38_name] -" if sscroll_38 or persistent.ss_38:
                ...
                "-S.39: [scroll_39_name] -" if sscroll_39 or persistent.ss_39:
                ...
                "-S.40: [scroll_40_name] -" if sscroll_40 or persistent.ss_40:
                ...
                "-S.41: [scroll_41_name] -" if sscroll_41 or persistent.ss_41:
                ...
                "-S.42: [scroll_42_name] -" if sscroll_42 or persistent.ss_42:
                ...
                "-S.43: [scroll_43_name] -" if sscroll_43 or persistent.ss_43:
                ...
                "-S.44: [scroll_44_name] -" if sscroll_44 or persistent.ss_44:
                ...
                "-S.45: [scroll_45_name] -" if sscroll_45 or persistent.ss_45:
